...
$this->router->screen('demokit/step2/{postscreen}/edit', DemokitStep2Edit::class)->name('platform.demokit.step2.edit');
...
$this->router->screen('demokit/step4/{step3}/column', DemokitStep4::class)->name('platform.demokit.step4');
